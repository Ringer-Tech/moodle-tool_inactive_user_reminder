...
/**
 * Strings for component 'tool_inactive_user_reminder', language 'en', branch 'MOODLE_22_STABLE'
 *
...
$string['invalaliddayofinactivity'] = 'tool_inactive_user_reminder disabled for putting invalid value in "Days Of Inactivity", the value should be greater than "0"';
$string['taskstart'] = 'Hey, admin tool inactive user cleanup is running';
$string['taskend'] = 'tool_inactive_user_reminder task finished';
